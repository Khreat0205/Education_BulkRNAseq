...
pcaData <- plotPCA( ### , # vst() returns tranformed, normalized counts from DESeqDataset
...
corData <- cor( ### , method = 'pearson') # we used pearson's correlation, but you can use kendall rank correlation and spearman's correlation as well
...
#   - since the default paramter of order() is to sort in ascending order, you don't have to use any paramter in this 
